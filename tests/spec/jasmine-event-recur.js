...
describe("An interval", function() {
    ...
    it("can be monthly", function() {
        var recurrence = moment(startDate, 'MM/DD/YYYY').recur().every(3).months();
        var check = moment(startDate, 'MM/DD/YYYY').add(3, "months");
        expect(recurrence.matches( check )).toBe(true);
        expect(recurrence.matches( moment(startDate, 'MM/DD/YYYY').add(2, "months") )).toBe(false);
        expect(recurrence.matches( moment(startDate, 'MM/DD/YYYY').add(2, "days"))).toBe(false);
    });
